...
exports.tambah = (data) =>
  new Promise((resolve, reject) => {
    userModel
      .create(data)
      .then(() => {
        console.log(requestResponse.berhasil("Berhasil Input Supplier"));
...
exports.getAllUser = () =>
  new Promise((resolve, reject) => {
    userModel
      .find({})
      .then((user) => {
        console.log(requestResponse.berhasil("berhasil get Supplier"));
    ...
    userModel
      ...
      .then((data) => {
        userModel
          ...
          .then(() => {
            console.log(requestResponse.berhasil("berhasil delete Supplier"));
...
exports.edit = (data, id) =>
  new Promise(async (resolve, reject) => {
    ...
    userModel
      ...
      .then(() => {
        console.log(requestResponse.berhasil("Berhasil Edit Supplier"));
